...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy FlowcontrolV1beta1Subject)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy RbacV1beta1Subject)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1EphemeralContainers)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1IngressClassParametersReference)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1TokenRequest)
