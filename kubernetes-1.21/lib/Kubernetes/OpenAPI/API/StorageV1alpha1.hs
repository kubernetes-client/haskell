...
-- 
createNamespacedCSIStorageCapacity
  :: (Consumes CreateNamespacedCSIStorageCapacity contentType, MimeRender contentType V1alpha1CSIStorageCapacity)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1alpha1CSIStorageCapacity -- ^ "body"
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest CreateNamespacedCSIStorageCapacity contentType V1alpha1CSIStorageCapacity accept
createNamespacedCSIStorageCapacity _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateNamespacedCSIStorageCapacity 
instance HasBodyParam CreateNamespacedCSIStorageCapacity V1alpha1CSIStorageCapacity 
...
deleteCollectionNamespacedCSIStorageCapacity _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteNamespacedCSIStorageCapacity _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listCSIStorageCapacityForAllNamespaces
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListCSIStorageCapacityForAllNamespaces MimeNoContent V1alpha1CSIStorageCapacityList accept
listCSIStorageCapacityForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/storage.k8s.io/v1alpha1/csistoragecapacities"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listNamespacedCSIStorageCapacity
  :: Accept accept -- ^ request accept ('MimeType')
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ListNamespacedCSIStorageCapacity MimeNoContent V1alpha1CSIStorageCapacityList accept
listNamespacedCSIStorageCapacity  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchNamespacedCSIStorageCapacity
  ...
  -> Name -- ^ "name" -  name of the CSIStorageCapacity
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedCSIStorageCapacity contentType V1alpha1CSIStorageCapacity accept
patchNamespacedCSIStorageCapacity _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readNamespacedCSIStorageCapacity
  ...
  -> Name -- ^ "name" -  name of the CSIStorageCapacity
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedCSIStorageCapacity MimeNoContent V1alpha1CSIStorageCapacity accept
readNamespacedCSIStorageCapacity  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- 
replaceNamespacedCSIStorageCapacity
  :: (Consumes ReplaceNamespacedCSIStorageCapacity contentType, MimeRender contentType V1alpha1CSIStorageCapacity)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1alpha1CSIStorageCapacity -- ^ "body"
  -> Name -- ^ "name" -  name of the CSIStorageCapacity
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedCSIStorageCapacity contentType V1alpha1CSIStorageCapacity accept
replaceNamespacedCSIStorageCapacity _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/storage.k8s.io/v1alpha1/namespaces/",toPath namespace,"/csistoragecapacities/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedCSIStorageCapacity 
instance HasBodyParam ReplaceNamespacedCSIStorageCapacity V1alpha1CSIStorageCapacity 
