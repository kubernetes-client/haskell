...
patchNamespacedPodEphemeralcontainers
  ...
  -> Accept accept -- ^ request accept ('MimeType')
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the EphemeralContainers
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedPodEphemeralcontainers contentType V1EphemeralContainers accept
...
readNamespacedPodEphemeralcontainers
  ...
  -> Name -- ^ "name" -  name of the EphemeralContainers
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedPodEphemeralcontainers MimeNoContent V1EphemeralContainers accept
...
-- 
replaceNamespacedPodEphemeralcontainers
  :: (Consumes ReplaceNamespacedPodEphemeralcontainers contentType, MimeRender contentType V1EphemeralContainers)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1EphemeralContainers -- ^ "body"
  -> Name -- ^ "name" -  name of the EphemeralContainers
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedPodEphemeralcontainers contentType V1EphemeralContainers accept
...
instance HasBodyParam ReplaceNamespacedPodEphemeralcontainers V1EphemeralContainers 
