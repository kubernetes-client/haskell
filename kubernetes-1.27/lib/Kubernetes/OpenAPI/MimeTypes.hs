...
data MimeJwkSetjson = MimeJwkSetjson deriving (P.Typeable)

-- | @application/jwk-set+json@
instance MimeType MimeJwkSetjson where
  mimeType _ = Just $ P.fromString "application/jwk-set+json"
instance A.ToJSON a => MimeRender MimeJwkSetjson a where mimeRender _ = A.encode
instance A.FromJSON a => MimeUnrender MimeJwkSetjson a where mimeUnrender _ = A.eitherDecode
-- instance MimeRender MimeJwkSetjson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeJwkSetjson T.Text where mimeUnrender _ = undefined
