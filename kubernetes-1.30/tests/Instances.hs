...
genV1ValidatingAdmissionPolicyBindingList n =
  V1ValidatingAdmissionPolicyBindingList
    ...
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingListItems :: Maybe [V1ValidatingAdmissionPolicyBinding]
...
genV1ValidatingAdmissionPolicyList n =
  V1ValidatingAdmissionPolicyList
    ...
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyListItems :: Maybe [V1ValidatingAdmissionPolicy]
