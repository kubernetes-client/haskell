...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ServiceCIDR)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ServiceCIDRList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ServiceCIDRSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1ServiceCIDRStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2DriverAllocationResult)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2DriverRequests)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesAllocationResult)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesAttribute)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesFilter)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesInstance)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesIntSlice)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesResources)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2NamedResourcesStringSlice)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceClaimParameters)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceClaimParametersList)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceClassParameters)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceClassParametersList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceClassParametersReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceFilter)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceHandle)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceSlice)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2ResourceSliceList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2StructuredResourceHandle)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2VendorParameters)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta3ExemptPriorityLevelConfiguration)
