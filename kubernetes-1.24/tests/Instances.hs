...
genV1NetworkPolicy n =
  V1NetworkPolicy
    ...
    <*> arbitraryReducedMaybe n -- v1NetworkPolicyStatus :: Maybe V1NetworkPolicyStatus
...
instance Arbitrary V1NetworkPolicyStatus where
  arbitrary = sized genV1NetworkPolicyStatus

genV1NetworkPolicyStatus :: Int -> Gen V1NetworkPolicyStatus
genV1NetworkPolicyStatus n =
  V1NetworkPolicyStatus
    <$> arbitraryReducedMaybe n -- v1NetworkPolicyStatusConditions :: Maybe [V1Condition]
...
genV1PersistentVolumeClaimSpec n =
  V1PersistentVolumeClaimSpec
    ...
    <*> arbitraryReducedMaybe n -- v1PersistentVolumeClaimSpecDataSourceRef :: Maybe V1TypedLocalObjectReference
...
genV1PersistentVolumeClaimStatus n =
  V1PersistentVolumeClaimStatus
    ...
    <*> arbitraryReducedMaybe n -- v1PersistentVolumeClaimStatusResizeStatus :: Maybe Text
...
genV1beta1CronJobSpec n =
  V1beta1CronJobSpec
    ...
    <*> arbitraryReducedMaybe n -- v1beta1CronJobSpecTimeZone :: Maybe Text
...
genV1beta1PolicyRulesWithSubjects n =
  V1beta1PolicyRulesWithSubjects
    ...
    <*> arbitraryReduced n -- v1beta1PolicyRulesWithSubjectsSubjects :: [V1beta1Subject]
...
genV1beta1Subject n =
  V1beta1Subject
    <$> arbitraryReducedMaybe n -- v1beta1SubjectGroup :: Maybe V1beta1GroupSubject
    <*> arbitrary -- v1beta1SubjectKind :: Text
    <*> arbitraryReducedMaybe n -- v1beta1SubjectServiceAccount :: Maybe V1beta1ServiceAccountSubject
    <*> arbitraryReducedMaybe n -- v1beta1SubjectUser :: Maybe V1beta1UserSubject
...
genV2beta1HorizontalPodAutoscalerStatus n =
  V2beta1HorizontalPodAutoscalerStatus
    <$> arbitraryReducedMaybe n -- v2beta1HorizontalPodAutoscalerStatusConditions :: Maybe [V2beta1HorizontalPodAutoscalerCondition]
...
genV2beta2HorizontalPodAutoscalerStatus n =
  V2beta2HorizontalPodAutoscalerStatus
    <$> arbitraryReducedMaybe n -- v2beta2HorizontalPodAutoscalerStatusConditions :: Maybe [V2beta2HorizontalPodAutoscalerCondition]
