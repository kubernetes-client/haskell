...
-- | @PATCH \/apis\/certificates.k8s.io\/v1beta1\/certificatesigningrequests\/{name}\/approval@
-- 
...
patchCertificateSigningRequestApproval
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the CertificateSigningRequest
  -> KubernetesRequest PatchCertificateSigningRequestApproval contentType V1beta1CertificateSigningRequest accept
patchCertificateSigningRequestApproval _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/",toPath name,"/approval"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
-- | @GET \/apis\/certificates.k8s.io\/v1beta1\/certificatesigningrequests\/{name}\/approval@
-- 
...
readCertificateSigningRequestApproval  _ (Name name) =
  _mkRequest "GET" ["/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/",toPath name,"/approval"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
