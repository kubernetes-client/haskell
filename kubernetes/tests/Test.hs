...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1AllowedCSIDriver)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1AllowedFlexVolume)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1AllowedHostPath)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1FSGroupStrategyOptions)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1HostPortRange)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1IDRange)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1PodSecurityPolicyList)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1PodSecurityPolicySpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1RunAsGroupStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1RunAsUserStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1RuntimeClassStrategyOptions)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ExtensionsV1beta1SupplementalGroupsStrategyOptions)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1AllowedCSIDriver)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1AllowedFlexVolume)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1AllowedHostPath)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1FSGroupStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1HostPortRange)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1IDRange)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1PodSecurityPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1PodSecurityPolicyList)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1PodSecurityPolicySpec)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1RunAsGroupStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1RunAsUserStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1RuntimeClassStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1SELinuxStrategyOptions)
      propMimeEq MimeJSON (Proxy :: Proxy PolicyV1beta1SupplementalGroupsStrategyOptions)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1Endpoint)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1EndpointConditions)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1EndpointPort)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1EndpointSlice)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1EndpointSliceList)
