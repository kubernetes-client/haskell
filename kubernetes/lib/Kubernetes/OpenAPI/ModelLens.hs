...
-- | 'v1ServiceReferencePort' Lens
v1ServiceReferencePortL :: Lens_' V1ServiceReference (Maybe Int)
v1ServiceReferencePortL f V1ServiceReference{..} = (\v1ServiceReferencePort -> V1ServiceReference { v1ServiceReferencePort, ..} ) <$> f v1ServiceReferencePort
{-# INLINE v1ServiceReferencePortL #-}
