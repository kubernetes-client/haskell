...
deleteCollectionCSIDriver 
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest DeleteCollectionCSIDriver MimeNoContent V1Status accept
deleteCollectionCSIDriver  _ =
...
deleteCollectionCSINode 
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest DeleteCollectionCSINode MimeNoContent V1Status accept
deleteCollectionCSINode  _ =
