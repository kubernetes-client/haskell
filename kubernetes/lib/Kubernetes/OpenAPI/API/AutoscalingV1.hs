...
-- | @*/*@
instance MimeType mtype => Consumes ListHorizontalPodAutoscalerForAllNamespaces mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ListNamespacedHorizontalPodAutoscaler mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadNamespacedHorizontalPodAutoscaler mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadNamespacedHorizontalPodAutoscalerStatus mtype
