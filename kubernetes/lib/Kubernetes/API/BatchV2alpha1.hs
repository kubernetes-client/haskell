...
{-|
Module : Kubernetes.API.BatchV2alpha1
-}
...
-- | @*/*@
instance MimeType mtype => Consumes ListCronJobForAllNamespaces mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ListNamespacedCronJob mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadNamespacedCronJob mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadNamespacedCronJobStatus mtype
