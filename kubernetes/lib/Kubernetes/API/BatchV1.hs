...
-- | @*/*@
instance MimeType mtype => Consumes ListJobForAllNamespaces mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ListNamespacedJob mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadNamespacedJob mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadNamespacedJobStatus mtype
