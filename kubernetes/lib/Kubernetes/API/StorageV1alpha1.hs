...
{-|
Module : Kubernetes.API.StorageV1alpha1
-}
...
-- | @*/*@
instance MimeType mtype => Consumes ListVolumeAttachment mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadVolumeAttachment mtype
