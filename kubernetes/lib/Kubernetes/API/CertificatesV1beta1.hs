...
{-|
Module : Kubernetes.API.CertificatesV1beta1
-}
...
-- | @*/*@
instance MimeType mtype => Consumes ListCertificateSigningRequest mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadCertificateSigningRequest mtype
