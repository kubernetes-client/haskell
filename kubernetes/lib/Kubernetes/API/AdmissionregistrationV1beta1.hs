...
{-|
Module : Kubernetes.API.AdmissionregistrationV1beta1
-}
...
-- | @*/*@
instance MimeType mtype => Consumes ListMutatingWebhookConfiguration mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ListValidatingWebhookConfiguration mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadMutatingWebhookConfiguration mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadValidatingWebhookConfiguration mtype
