...
{-|
Module : Kubernetes.API.SchedulingV1alpha1
-}
...
-- | @*/*@
instance MimeType mtype => Consumes ListPriorityClass mtype
...
-- | @*/*@
instance MimeType mtype => Consumes ReadPriorityClass mtype
